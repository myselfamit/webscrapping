...
df1 = pd.read_csv('/home/ec2-user/e/trial/code6/cleaned_100items.csv')

df2 = pd.read_csv('/home/ec2-user/e/trial/code6/cleaned_product_details_urls.csv')
...
path3 = f"/home/ec2-user/e/trial/code6/final/final_amazon_{x}.csv"
